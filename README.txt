...
This a test version of our project titled UnoGame. There are two files UnoClass.py and UnoGame.py. UnoClass is a module that
contains the classes used for the game. Run UnoGame.py to play the game. As of now, the game is fully text-based but we will
...
2) Choosing a card:
	There is some try/except stuff here to ensure that the card being played is allowed to be played according to the rules. Try testing out cards
 	that can't be played and make sure that the exceptions are handled properly.
